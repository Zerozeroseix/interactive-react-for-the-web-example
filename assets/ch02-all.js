	...
	(function (a, b, c) {
		...
		(a.fn.init = function (b, e, f) {
			...
			return b &&
				...
				: ("#" === b
						? (d("jQuery( '#' ) is not a valid selector"), (b = []))
						: t.test(b) &&
							d("Attribute selectors with '#' must be quoted: '" + b + "'"),
			...
			I = function (b) {
				return "string" != typeof b || a.event.special.hover
					...
					: (H.test(b) &&
						...
						b && b.replace(H, "mouseenter$1 mouseleave$1"));
			};
		a.event.props &&
			...
			(a.event.trigger = function (a, b, c, e) {
				return (
					c || G.test(a) || d("Global events are undocumented and deprecated"),
					A.call(this, a, b, c || document, e)
				);
			}),
...
!(function (e) {
	function t(t, n, i) {
		i = i || "transparent";
		var a = "obj" + ("" + Math.random()).slice(2, 15),
			o = '<object class="fp-engine" id="' + a + '" name="' + a + '" ';
		o += e.browser.msie
							...
							: "string" == typeof t &&
								...
								e.each(i, function (e, n) {
									"flash" != n.type &&
										t.sources.push({
											type: n.type,
											src: t.src.replace(x, "." + n.suffix + "$2"),
										});
								})),
						t)
					: { sources: i };
	...
	try {
		"object" == typeof window.localStorage &&
			((window.localStorage.flowplayerTestStorage = "test"), (p = !0));
	} catch (v) {}
	var g =
		/Safari/.exec(navigator.userAgent) && !/Chrome/.exec(navigator.userAgent);
	(m = /(\d+\.\d+) Safari/.exec(navigator.userAgent)),
		...
		e.extend(flowplayer, {
			...
			defaults: {
				...
				playlist: [],
				hlsFix: g && 8 > safariVersion,
			},
		});
	var h = 1;
	(e.fn.flowplayer = function (t, n) {
		return (
			"string" == typeof t && (t = { swf: t }),
			...
			(!t && this.data("flowplayer")) ||
				this.each(function () {
					...
					g && g.unload(),
						o.data("fp-player_id", o.data("fp-player_id") || h++);
					try {
					...
					var w = g || {
						conf: r,
						currentSpeed: 1,
						volumeLevel: r.volume === void 0 ? 1 * f.volume : r.volume,
						video: {},
						disabled: !1,
						finished: !1,
						loading: !1,
						...
						resume: function () {
							return (
								w.ready &&
									...
									!w.disabled &&
									(a.resume(),
									w.finished && (w.trigger("resume", [w]), (w.finished = !1))),
								w
							);
						},
						toggle: function () {
							...
							if (w.ready && !w.live) {
								...
								o.trigger(s, [w, t]),
									s.isDefaultPrevented()
										? ((w.seeking = !1), o.toggleClass("is-seeking", w.seeking))
										: (a.seek(t), e.isFunction(n) && o.one("seek", n));
							}
							return w;
						},
						seekTo: function (e, t) {
							var n = void 0 === e ? i : 0.1 * w.video.duration * e;
							return w.seek(n, t);
						},
						mute: function (e) {
							return (
								void 0 === e && (e = !w.muted),
								(f.muted = w.muted = e),
								(f.volume = isNaN(f.volume) ? r.volume : f.volume),
								w.volume(e ? 0 : f.volume, !0),
								w.trigger("mute", e),
								w
							);
						},
							...
							return (
								w.ready &&
									("boolean" == typeof t &&
										(t =
											r.speeds[
												e.inArray(w.currentSpeed, r.speeds) + (t ? 1 : -1)
											] || w.currentSpeed),
									a.speed(t),
									n && o.one("speed", n)),
								w
						...
						unload: function () {
							return (
								o.hasClass("is-embedding") ||
									(r.splash ? (w.trigger("unload"), a.unload()) : w.stop()),
								w
							);
						},
						disable: function (e) {
							return (
								void 0 === e && (e = !w.disabled),
								e != w.disabled && ((w.disabled = e), w.trigger("disable", e)),
								w
							);
						},
					};
					(w.conf = e.extend(w.conf, r)),
						...
						o.data("flowplayer") ||
							o
								.bind("boot", function () {
									return (
										...
										(r.splash ||
											...
											((w.forcedSplash = !r.splash && !o.hasClass("is-splash")),
											(w.splash = r.splash = r.autoplay = !0),
											o.addClass("is-splash"),
											flowplayer.support.video && l.attr("preload", "none")),
										(r.live || o.hasClass("is-live")) &&
											((w.live = r.live = !0), o.addClass("is-live")),
										e.each(c, function () {
											this(w, o);
										}),
										...
										a.pick(d.initialSources)
											...
											: e.each(flowplayer.engine, function (e) {
													return e != r.engine &&
														((a = this(w, o)), a.pick(d.initialSources))
														? ((w.engine = e), !1)
														: void 0;
												}),
										u.push(w),
										w.engine
											? (r.splash ? w.unload() : w.load(),
												r.disabled && w.disable(),
												a.volume(w.volumeLevel),
												o.one("ready", n),
												void 0)
											: w.trigger("error", {
								...
								.bind("ready", function (e, t, n) {
									...
									var a = t.conf.hlsFix && /mpegurl/i.exec(n.type);
									o.toggleClass("hls-fix", !!a);
								})
								...
								.bind("beforeseek seek", function (e) {
									(w.seeking = "beforeseek" == e.type),
										o.toggleClass("is-seeking", w.seeking);
								})
								.bind(
									"ready pause resume unload finish stop",
									function (e, t, n) {
										(w.paused = /pause|finish|unload|stop/.test(e.type)),
											"ready" == e.type &&
												((w.paused = "none" == r.preload),
												n &&
													(w.paused =
														!n.duration ||
											...
											(w.playing = !w.paused),
											o
												.toggleClass("is-paused", w.paused)
												.toggleClass("is-playing", w.playing),
											w.load.ed || w.pause();
									},
								)
		...
		!(function () {
			var t = function (e) {
				...
				f = /Silk/.test(o),
				p = /IEMobile/.test(o),
				v = p ? parseFloat(/Windows\ Phone\ (\d+\.\d+)/.exec(o)[1], 10) : 0,
				m = p ? parseFloat(/IEMobile\/(\d+\.\d+)/.exec(o)[1], 10) : 0,
				g =
					(s ? t(o) : 0,
			...
			e.extend(n, {
				...
				inlineVideo: !d && (!p || (v >= 8.1 && m >= 11)) && (!u || g >= 3),
				hlsDuration: !u && (!i.safari || s || d || l),
				seekable: !s && !l,
			});
			try {
				var h = navigator.plugins["Shockwave Flash"],
					y = r
				...
				r || h[0].enabledPlugin
					? ((y = y.split(/\D+/)),
						y.length && !y[0] && (y = y.slice(1)),
						(n.flashVideo = y[0] > 9 || (9 == y[0] && y[3] >= 115)))
					: (n.flashVideo = !1);
			} catch (b) {}
			try {
		...
		(flowplayer.engine.flash = function (n, i) {
			...
			var l = e(window),
				d = function () {
					if ("webkit" == _ || P) {
						var t = e("object param[name='flashvars']", i),
							a = (t.attr("value") || "").split("&");
						e.each(a, function (e, i) {
							return (
								(i = i.split("=")),
								"url" == i[0] && i[1] != n.video.url
									? ((a[e] = "url=" + n.video.url),
										t.attr({ value: a.join("&") }),
										!1)
									: void 0
				...
				u = function (t) {
					...
					if (n.conf.flashfit || /full/.test(t.type)) {
						var r,
							...
							f = d ? (u ? screen.width : l.width()) : o,
							p = d ? (u ? screen.height : l.height()) : a,
							v = 0,
							m = 0,
							g = c ? o : "",
							h = c ? a : "";
						(n.conf.flashfit || "fullscreen" === t.type) &&
							...
							(g = g > f ? h * r : g),
							(g = Math.min(Math.round(g), f)),
							(m = Math.max(Math.round((p + m - h) / 2), 0)),
							(v = Math.max(Math.round((f + v - g) / 2), 0))),
							e("object", i).css({
								width: g,
								height: h,
								marginTop: m,
				...
				c = {
					pick: function (t) {
						if (flowplayer.support.flashVideo) {
							...
							for (var i, a = 0; t.length > a; a++)
								if (((i = t[a]), /mp4|flv/i.test(i.type))) return i;
						}
					},
					load: function (l) {
						function c(e) {
						...
						if (
							(flowplayer.support.video && f.prop("autoplay") && m(l.sources)
								? f.one("timeupdate", v)
								: v(),
							is_absolute || s.rtmp || (p = e("<img/>").attr("src", p)[0].src),
							r)
						)
							r.__play(p);
						else {
							n.bind("ready", d).bind("ready fullscreen fullscreen-exit", u),
							...
							i.data("origin") && (g.origin = i.data("origin")),
								...
								e.each(
									...
									function (e, t) {
										s.hasOwnProperty(t) && (g[t] = s[t]);
									},
								),
								void 0 !== s.bufferTime && (g.bufferTime = s.bufferTime),
								g.rtmp && (g.rtmp = c(g.rtmp)),
								(g.initialVolume = n.volumeLevel),
								(o = t(s.swf, g, s.wmode)),
								o.prependTo(i),
								(r = o[0]),
								setTimeout(function () {
								...
								setTimeout(function () {
									r.PercentLoaded === void 0 && i.trigger("flashdisabled", [n]);
								}, 1e3),
								(r.pollInterval = setInterval(function () {
									if (r) {
										var e = r.__status ? r.__status() : null;
										e &&
											(n.trigger("progress", e.time),
											(l.buffer = (e.buffer / l.bytes) * l.duration),
					...
					unload: function () {
						r && r.__unload && r.__unload(),
							...
							n
								.unbind("ready", d)
								.unbind("ready fullscreen fullscreen-exit", u),
	...
	var y,
		...
		k = function (t) {
			return y
				? y.attr({ type: i(t.type), src: t.src })
				: (y = e("<video/>", {
						src: t.src,
						type: i(t.type),
						class: "fp-engine",
							...
							if (
								("progress" == r &&
									...
									setTimeout(function () {
										t.video.duration ||
											(t.conf.live &&
												("mpegurl" !== t.video.type || !f.hlsDuration)) ||
											((r = "error"), t.trigger(r, { code: 4 }));
									}, 1e4),
								p.debug && !/progress/.test(r) && console.log(a, "->", r, d),
								...
								switch (r) {
									case "ready":
										...
										try {
											u.seekable =
												(!p.live &&
													/mpegurl/i.test(s ? s.type || "" : "") &&
													o.duration) ||
												(o.seekable && o.seekable.end(null));
										} catch (v) {}
										if (
											((l =
												l ||
									...
									case "progress":
									case "seek":
										if ((t.video.duration, o.currentTime > 0 || t.live)) {
		...
		return (s = {
			pick: function (e) {
				if (f.video) {
					...
					for (var n = 0; e.length > n; n++) if (a(e[n].type)) return e[n];
				}
			},
			load: function (n) {
				if (p.splash && !d)
					(c = k(n).prependTo(i)),
						f.inlineVideo || c.css({ position: "absolute", top: "-9999em" }),
						p.loop && c.attr("loop", "loop"),
						(d = c[0]),
						u !== void 0 && (d.volume = u);
				else {
					d = c[0];
					...
					!d.src && a.length && ((d.src = n.src), a.remove()),
						t.video.src && n.src != t.video.src
							? (c.attr("autoplay", "autoplay"), (d.src = n.src))
							: ("none" != p.preload && f.dataload) ||
								(f.zeropreload
									? t
											.trigger("ready", n)
											.trigger("pause")
				...
				r(d, e("source", c).add(c), n),
					(("none" != p.preload && "mpegurl" != n.type) ||
						!f.zeropreload ||
						!f.dataload) &&
						d.load(),
					p.splash && d.load();
				...
				var i,
					...
					w = {
						...
						disableAnimation: function (e, t) {
							(v = e !== !1), c.toggleClass("no-animation", !!t);
						},
					};
				m(),
			...
			t
				.bind("ready", function () {
					...
					w.disable(t.disabled || !e),
						...
						"flash" === t.engine && w.disableAnimation(!0, !0);
				})
				.bind("unload", function () {
					y || m.css("paddingTop", "");
				})
				...
				.bind("contextmenu", function (t) {
					...
					var i = n.offset(),
						...
						s = n
							...
							.css({ left: o + "px", top: r + "px", display: "block" })
							.on("click", function (e) {
								e.stopPropagation();
							});
				...
				.bind("flashdisabled", function () {
					n.addClass("is-flash-disabled")
						.one("ready", function () {
							n.removeClass("is-flash-disabled")
								.find(".fp-flash-disabled")
								.remove();
						})
						.append(
							'<div class="fp-flash-disabled">Adobe Flash is disabled for this page, click player area to enable.</div>',
						);
				}),
	...
	e(document).bind("keydown.fp", function (t) {
		...
		if (n && o.keyboard && !n.disabled) {
			if (-1 != e.inArray(a, [63, 187, 191])) return T.toggleClass(S), !1;
			if (27 == a && T.hasClass(S)) return T.toggleClass(S), !1;
			if (!i && n.ready) {
		...
		flowplayer(function (t, n) {
			if (t.conf.keyboard) {
				n.bind("mouseenter mouseleave", function (e) {
					(C = t.disabled || "mouseenter" != e.type ? 0 : t), C && (T = n);
				});
				var i =
					flowplayer.support.video &&
					"flash" !== t.conf.engine &&
					e("<video/>")[0].playbackRate
						? "<p><em>shift</em> + <em>&#8592;</em><em>&#8594;</em>slower / faster</p>"
						: "";
				n.append(
					'      <div class="fp-help">         <a class="fp-close"></a>         <div class="fp-help-section fp-help-basics">            <p><em>space</em>play / pause</p>            <p><em>q</em>unload | stop</p>            <p><em>f</em>fullscreen</p>' +
						i +
						'         </div>         <div class="fp-help-section">            <p><em>&#8593;</em><em>&#8595;</em>volume</p>            <p><em>m</em>mute</p>         </div>         <div class="fp-help-section">            <p><em>&#8592;</em><em>&#8594;</em>seek</p>            <p><em>&nbsp;. </em>seek to previous            </p><p><em>1</em><em>2</em>&hellip; <em>6</em> seek to 10%, 20% &hellip; 60% </p>         </div>      </div>   ',
				),
					t.conf.tooltip &&
						e(".fp-ui", n)
	...
	var F,
		_ = e.browser.mozilla ? "moz" : "webkit",
		E = "fullscreen",
		M = "fullscreen-exit",
		A = flowplayer.support.fullscreen,
		D =
			("function" == typeof document.exitFullscreen,
			navigator.userAgent.toLowerCase()),
		P = /(safari)[ \/]([\w.]+)/.exec(D) && !/(chrome)[ \/]([\w.]+)/.exec(D);
	e(document).bind(
					...
					(t.fullscreen = function (r) {
						if (!t.disabled) {
							if (
								...
								("webkit" != _ && !P) ||
									"flash" != t.engine ||
									(o = { apply: !0, pos: t.video.time, play: t.playing }),
								A)
							)
								if (r) {
									var s = n[0];
									...
									e.each(
										...
										function (e, t) {
											return "function" == typeof document[t]
												? (document[t](), !1)
												: void 0;
										},
									);
							else t.trigger(r ? E : M, [t]);
							return t;
						}
					});
				var r;
				n.bind("mousedown.fs", function () {
					150 > +new Date() - r && t.ready && t.fullscreen(), (r = +new Date());
				}),
					t
						.bind(E, function () {
						...
						.bind(M, function () {
							...
							A ||
								"html5" !== t.engine ||
								((e = n.css("opacity") || ""), n.css("opacity", 0)),
						...
						.bind("ready", function () {
							if (o.apply) {
								var n = function () {
									o.play || t.conf.live ? t.resume() : t.pause(),
										e.extend(o, { pos: 0, play: !1 });
								};
								t.conf.live
									? n()
									: t.conf.rtmp && o.pos && !isNaN(o.pos)
										? (t.resume(), t.seek(o.pos, n))
										: n();
							}
						});
			}
			...
			(t.play = function (n) {
				...
				o.advance &&
					n.unbind("finish.pl").bind("finish.pl", function (e, t) {
						var i = t.video.index >= 0 ? t.video.index + 1 : void 0;
						t.conf.playlist.length > i || o.loop
			...
			if (i().length) {
				...
				t.bind("load", function (i, o, s) {
					...
					n
						.removeClass("video" + d)
						.addClass("video" + c)
						.toggleClass("last-video", p),
						(s.index = o.video.index = c),
						(s.is_last = o.video.is_last = p),
	...
	flowplayer(function (t, n) {
		function i(e) {
			(n[0].className = n[0].className.replace(L, " ")),
		...
		(t.cuepoints = t.conf.cuepoints || []),
			t
				.bind("progress", function (e, o, r) {
					...
					a = r;
					for (var s, l = t.cuepoints || [], d = 0; l.length > d; d++)
						(s = l[d]),
							isNaN(s) || (s = { time: s }),
							0 > s.time && (s.time = t.video.duration + s.time),
							(s.index = d),
		...
		flowplayer(function (t, n) {
			...
			if (
				...
				if (!t.subtitles) return;
				var r = function (t) {
					var i = e("video", n)[0].textTracks;
					i.length && (i[0].mode = t);
				};
				return (
					r("disabled"),
					t.one("ready", function () {
						t.conf.splash &&
							e("video.fp-engine", n).append(
								e("<track />").attr({
									kind: "subtitles",
									srclang: t.subtitles.language || "en",
									label: t.subtitles.language || "en",
									src: a.attr("src"),
									default: "default",
								}),
							),
			...
			if (l) {
				setTimeout(function () {
					e.get(l, function (n) {
						for (
							var a, o, r, l, d = 0, u = n.split("\n"), c = u.length, f = {};
							c > d;
							d++
						)
							if ((o = s.exec(u[d]))) {
								for (
									a = u[d - 1], r = "<p>" + u[++d] + "</p><br/>";
									e.trim(u[++d]) && u.length > d;
								)
									r += "<p>" + u[d] + "</p><br/>";
								(f = {
									title: a,
						...
						return t.trigger("error", { code: 8, url: l }), !1;
					});
				});
				var d,
					u = e("<div class='fp-subtitle'/>").appendTo(n);
				t.bind("cuepoint", function (e, t, n) {
					n.subtitle
						? ((d = n.index), u.html(n.subtitle.text).addClass("fp-active"))
						: n.subtitleEnd && (u.removeClass("fp-active"), (d = n.index));
				}).bind("seek", function (n, i, a) {
					d &&
						t.cuepoints[d] &&
						t.cuepoints[d].time > a &&
						(u.removeClass("fp-active"), (d = null)),
						e.each(t.cuepoints || [], function (e, n) {
							var i = n.subtitle;
							i && d != n.index
								? a >= n.time &&
									(!i.endTime || i.endTime >= a) &&
				...
				if (o && "undefined" != typeof _gat) {
					...
					e._setAllowLinker(!0),
						e._trackEvent(
							...
							t.engine + "/" + i.type,
							n.attr("title") || i.src.split("/").slice(-1)[0].replace(x, ""),
							Math.round(o / 1e3),
						),
						(o = 0);
				}
	...
	(flowplayer.support.touch || I) &&
		flowplayer(function (t, n) {
			...
			if (i) {
				...
				t.bind("ready pause unload", function () {
					s && (clearInterval(s), (s = null));
				}),
					t.bind("ready", function () {
						l = 0;
					}),
					t.bind("resume", function (e, n) {
						return n.live
							? l
								? u(n)
								: (t.one("progress", function (e, t, n) {
										0 === n && u(t);
									}),
									void 0)
							: void 0;
			...
			flowplayer.support.volume || n.addClass("no-volume no-mute"),
				...
				(!flowplayer.support.inlineVideo || t.conf.native_fullscreen) &&
					(t.conf.nativesubtitles = !0);
			var c = !1;
			n
				...
				.bind("touchend click", function () {
					return c
						...
						: t.playing && !n.hasClass("is-mouseover")
							...
							: (t.paused &&
									n.hasClass("is-mouseout") &&
									!t.splash &&
									t.toggle(),
								t.paused && I && e("video.fp-engine", n)[0].play(),
								void 0);
				}),
		...
		flowplayer(function (t, n) {
			if (t.conf.embed !== !1) {
				...
				(t.embedCode = function () {
					...
					e.each(
						["origin", "analytics", "key", "rtmp", "subscribe", "bufferTime"],
						function (e, t) {
					...
					var d = { src: "//embed.flowplayer.org/5.5.2/embed.min.js" };
...
flowplayer(function (e, o) {
	...
	if (
		...
		r.logo &&
			o.append(
				a("<a>", { class: "fp-logo", href: i }).append(
					a("<img/>", { src: r.logo }),
				),
			);
	else {
		...
		a(".fp-controls", o);
		var p = a(
			'<div class="fp-context-menu"><ul><li class="copyright">&copy; 2014</li><li><a href="http://flowplayer.org">About Flowplayer</a></li><li><a href="http://flowplayer.org/license">GPL based license</a></li></ul></div>',
		).appendTo(o);
		...
		this.checkElements = function () {
			...
			$elem.each(function () {
				...
				if (scroll_offset != null && scroll_offset != "") {
					(elemTop =
						Math.round($obj.offset().top) +
						Math.round(Number(scroll_offset) * $obj.height() * 0.01)),
						(elemBottom = elemTop + $obj.height());
				} else {
					(elemTop =
						Math.round($obj.offset().top) +
						Math.round(options.offset * $obj.height() * 0.01)),
						(elemBottom = elemTop + $obj.height());
				}
...
jQuery(document).ready(($) => {
	...
	$(".search-toggle").on("click", function () {
		$(this).toggleClass("active");
		$(".header-search-block").toggleClass("hidden");
	...
	$(window).resize(() => {
		if ($(window).width() < 1000) {
			...
			$(".header-search-block").addClass("hidden");
		}
	});
